...
#macro C_THEN                    });__CoroutineThen(function(){
#macro C_YIELD                   });__CoroutineEscape(__COROUTINE_ESCAPE_STATE.__YIELD,function(){return 
#macro C_PAUSE                   });__CoroutineEscape(__COROUTINE_ESCAPE_STATE.__PAUSE,function(){return 
#macro C_RETURN                  });__CoroutineEscape(__COROUTINE_ESCAPE_STATE.__RETURN,function(){return 
#macro C_RESTART                 });__CoroutineEscape(__COROUTINE_ESCAPE_STATE.__RESTART,undefined);__CoroutineThen(function(){
#macro C_BREAK                   });__CoroutineBreak(function(){ //N.B. This opens a blind function - it is never executed
#macro C_CONTINUE                });__CoroutineContinue(function(){ //N.B. This opens a blind function - it is never executed
#macro C_REPEAT                  });__CoroutineRepeat(function(){return 
#macro C_WHILE                   });__CoroutineWhile(function(){return 
#macro C_FOREACH                 });__CoroutineForEach(function(_value){
#macro C_IN                      =_value;});__CoroutineForEachIn(function(){return 
#macro C_END                     });__CoroutineEndLoop(function(){
#macro C_IF                      });__CoroutineIf(function(){return 
#macro C_ELSE                    });__CoroutineElse(function(){
#macro C_ELSE_IF                 });__CoroutineElseIf(function(){return 
#macro C_END_IF                  });__CoroutineEndIf(function(){
#macro C_AWAIT                   });__CoroutineAwait(function(){return 
#macro C_DELAY                   });__CoroutineDelay(function(){return 
#macro C_AWAIT_BROADCAST         });__CoroutineAwaitBroadcast(function(){return 
#macro C_AWAIT_FIRST             });__CoroutineAwaitFirst(function(){
#macro C_AWAIT_ALL               });__CoroutineAwaitAll(function(){
#macro C_AWAIT_ASYNC_HTTP        });__CoroutineAwaitAsync("http",function(){
#macro C_AWAIT_ASYNC_NETWORKING  });__CoroutineAwaitAsync("networking",function(){
#macro C_AWAIT_ASYNC_SOCIAL      });__CoroutineAwaitAsync("social",function(){
#macro C_AWAIT_ASYNC_SAVE_LOAD   });__CoroutineAwaitAsync("save_load",function(){
#macro C_AWAIT_ASYNC_DIALOG      });__CoroutineAwaitAsync("dialog",function(){
#macro C_AWAIT_ASYNC_SYSTEM      });__CoroutineAwaitAsync("system",function(){
#macro C_AWAIT_ASYNC_STEAM       });__CoroutineAwaitAsync("steam",function(){
#macro C_AWAIT_ASYNC_BROADCAST   });__CoroutineAwaitAsync("broadcast",function(){
#macro C_ASYNC_TIMEOUT           });__CoroutineAsyncTimeout(function(){return 
#macro C_ASYNC_COMPLETE          return true;